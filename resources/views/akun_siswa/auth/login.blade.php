    ...
    <div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
        ...
        <form method="POST" action="{{ route('akun_siswa.login') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <x-button class="mx-auto lg:mx-0 hover:underline bg-gradient-to-r from-blue-400 to-blue-700 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    {{ __('Login') }}
                </x-button>
            </div>
        </form>
